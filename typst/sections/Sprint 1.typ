...
#figure(
  ...
  [4], [Wireless connection], [Controllers should interface wirelessly with the Host.],
  [5], [NFC reader], [An NFC Reader should be used for changing the Controllers' instruments.],
