...
== Testing <sec:sprint5test>
The last round of user testing was conducted at Rosengårdskolen @rosengardskolen_velkommen_nodate and involved six individual participants from the 5th grade. Three had participated in the test during Sprint 4. Each session lasted approximately twelve minutes.

During the test, two functional Controllers were presented alongside a paper detailing extra instruments that could be played, but were not configured to NFC cards (@fig:sprint5setup). The testers would then have to say which of the extra instruments, they would like to play, whereafter a team member, would configure Live, so that their Controller was assigned to the correct MIDI channel. This was an imperfect solution but successfully resulted in the new instruments being tested.

Having two Controllers allowed for two participants to test the prototype together. Furthermore, it raised the opportunity of testing the proposed idea of a collaborative experience, enhancing the user experience. The test employed think-aloud methodology and unstructured interviews.
...
Notably, one participant reported being inspired to learn the cello after the experience, an indication of high engagement and possible intrinsic motivation @ryan_self-determination_2000. Although this sentiment was not shared by all, the Plug'N'Play nature of the NFC interaction was widely appreciated. One participant commented: #quote[It was very fun. Because you do not have to write all kinds of things, you just need to insert it, and then it works.] (@app:Sprint5Transcriptions). Finally, one pair of participants were excited about the idea of being able to buy the product as well.
