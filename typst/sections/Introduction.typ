...
In response to this challenge, this project investigates how the design of a _tangible hardware interface can facilitate music creation through curiosity-driven, playful and exploratory interactions_. By adopting an iterative design process, the project aims to examine whether such an interface can promote positive user experiences, and foster a lasting interest in music creation. The project involves working closely with the target group to collect user feedback, and evaluating the tool's perceived benefits.

Further research in this domain is essential, as traditional music education often presents high barriers to entry; such as the need for formal instruction, access to expensive instruments, and rigid teaching methods that may not resonate with all learners. By developing an alternative, tangible interface, this project seeks to gain insights into how technology can support inclusive, intrinsically motivating @ryan_self-determination_2000 learning experiences in music creation.
