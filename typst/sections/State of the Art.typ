...
These tangible music interfaces inherently connect with Self-Determination Theory (SDT) @ryan_self-determination_2000. SDT posits that humans possess three innate psychological needs crucial for intrinsic motivation and well-being:
...
When these needs are satisfied, motivation and psychological growth are enhanced. In tangible music interfaces, supporting autonomy (e.g., free exploration), competence (e.g., clear feedback), and relatedness (e.g., collaborative features) can significantly boost user engagement, learning, and satisfaction. SDT thus offers a valuable framework for evaluating the motivational impact of tangible music creation tools.