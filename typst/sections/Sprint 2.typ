...
Prototype evaluation was conducted at the University of Southern Denmark with five participants from the target user group. The breadboard prototype, which utilized WiFi for connectivity, was tested. During this evaluation, the display was intentionally disconnected from the main circuit due to observed interference (reference to section). Additionally, the NFC reader required a manual button press for activation. The participants were all enrolled at Teknologiskolen, an extracurricular program focused on technology education for children. Participants prior exposure to breadboard setups allowed for the testing of a very early prototype iteration without significant participant confusion. The testing procedure comprised of two main phases: A think-aloud protocol, where participants freely interacted with the prototype, followed by an unstructured interview. A/B tests were also utilized. Each test session averaged approximately 10 minutes.
...
None of the participants had recieved formal music training, but two reported regular playtime on keyboards at home. All participants expressed curiosity and interest in learning more about music creation. 
...
Regarding the prototype's power supply, a wired connect was preferred over batteries by participants due to the inconvenience of battery replacement: #quote[Yes, but maybe I think it's a bit easier with a cord, you know. Batteries—you actually have to go out and buy them.] (@app:Sprint2Transcriptions). This feedback was incorporated into subsequent prototyping phases. Furthermore, observations during the test revealed that all participants struggled to create cohesive beats. This difficulty was theorized to be a result of WiFi latency, which was noted as a critical area for improvement.

The concept of collaborative play was met with enthusiasm, as all testers expressed positive reactions to the idea of a shared music-making experience. However, one participant raised a valid concern: that simultaneous use of identical instrument sounds could lead to an uncomfortable auditory experience.

Finally, one participant requested additional instruments be added; #quote[Drums, guitar, piano, you know maybe something diverse? Sjubidu [...] Trumpet [...] Or do you know that instrument from Australia, that tube where you, uh, say weird sounds?] (@app:Sprint2Transcriptions).
