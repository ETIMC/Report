...
= Sprint 2: _Sprint 2, Sprint 2 and Sprint 2_
...
The four tactile switch buttons (@sec:sprint1MusicalInteraction) were added to the breadboard, according to the schematic. The buttons were implemented so that, when a button was pressed, the controller would send a single message to the host indicating which button had been activated (e.g., “Button 3 pressed”) (@listing:sprint2Buttons).
